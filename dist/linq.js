  ...
  function GroupBy (keySelector, ...args) {
    ...
    */
    function groupByOneArgument (keySelector) {
      return groupByFourArguments(keySelector, elem => elem, undefined, defaultEqualityCompareFn)
    }
    ...
    */
    ...
    switch (args.length) {
      ...
      case 2:
        ...
        break
      case 3:
        return groupByFourArguments(keySelector, args[0], args[1], args[2])
        break
      default:
