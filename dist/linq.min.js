...
function b(collection,originalFn,ZOrConstructor=x=>true,constructor=Object){let Z;if(j(ZOrConstructor)){Z=x=>true;constructor=ZOrConstructor} else{Z=ZOrConstructor}
L(Z);O(j(constructor),'constructor must be native constructor,e.g. Number!');const defaultVal=z(constructor);if(o(collection)){return defaultVal}
return originalFn.call(collection,Z)}
