...
function Range(start,count){ii(count,0,Infinity);return new Collection(function *(){let i=start;while(i!=count+start){yield i++}})}Object.defineProperty(Collection,'Empty',{get: function(){ return Collection.from([])}});const collectionStaticMethods={ from,From: from,Range }
