...
return OrderedCollection})();function GetComparatorFromKeySelector(nc,ic=defaultComparator){if(o(nc)){return new Function('ic','hcFn','a','b',`return ic(hcFn(a),hcFn(b))`).bind(null,ic,nc)}else if(i(nc)){if(!(nc.startsWith('[')||nc.startsWith('.'))){nc=`.${nc}`}return new Function('ic','a','b',`return ic(a${nc},b${nc})`).bind(null,ic)}}
