...
return !0}
let OrderedLinqCollection=(function(){function OrderedLinqCollection(V,comparator,heapConstructor){J(V);
L(comparator);
L(heapConstructor);
Collection.apply(this,[V]);
this.__comparator=comparator;
this.__heapConstructor=heapConstructor}
OrderedLinqCollection.prototype.ThenBy=function(qc){if(h(qc)){qc=GetComparatorFromKeySelector(qc)}
L(qc);
...
return qc(a,b)};
return this};
OrderedLinqCollection.prototype.x=function(){const _self=this;return function*(){yield* Reflect.construct(_self.__heapConstructor,[[..._self.V],_self.__comparator])}()}
